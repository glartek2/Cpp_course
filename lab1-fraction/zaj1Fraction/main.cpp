...
constexpr const char* const FIRSTNAME = "Sebastian";
constexpr const char* const SURNAME   = "Kasinski";
constexpr const char* const MAIL    = "skasinski@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "418136";
